		...
		<div class="col-md-9 total-news" style="margin-top: 15px;">
			 <form role ="search" method="get" id="searchform" action="{{route('search')}}">
				...
				<div class="col-md-3 side-bar" style="margin-top:50px">
						<div class="clearfix"></div>
						<div class="subscribe-now" style="width:300px; position:absolute; cursor:pointer; left: 55px">
								<img src="/WebGiaoThong/public/upload/ads/7.gif" style="width:210px; height:530px; margin-bottom:15px"/>
								<img src="/WebGiaoThong/public/upload/ads/160x600.gif" style="width:210px; height:530px; margin-bottom:15px"/>
								<img src="/WebGiaoThong/public/upload/ads/qc.gif" style="width:210px; height:530px; margin-bottom:15px"/>
								<img src="/WebGiaoThong/public/upload/ads/addt.gif" style="width:210px; height:530px; margin-bottom:15px"/>
								<img src="/WebGiaoThong/public/upload/ads/138.com.gif" style="width:210px; height:530px; margin-bottom:15px"/>
								<img src="/WebGiaoThong/public/upload/ads/170203-0657A.gif" style="width:210px; height:530px; margin-bottom:15px"/>
								<img src="/WebGiaoThong/public/upload/ads/170306-1248A.gif" style="width:210px; height:530px; margin-bottom:15px"/>
								<img src="/WebGiaoThong/public/upload/ads/130x450.gif" style="width:210px; height:530px; margin-bottom:15px"/>
								<img src="/WebGiaoThong/public/upload/ads/qcalt.gif" style="width:210px; height:530px; margin-bottom:15px"/>
						</div>
						<div class="clearfix"></div>
				</div>
