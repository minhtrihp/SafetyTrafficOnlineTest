...
@section('content_admin')
            <div class="container-fluid" style="margin-left: 300px; margin-top: 30px;">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">B1 License Question Tests
                            <small>Edit</small>
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                    <div class="col-lg-7" style="padding-bottom:120px">
                        ...
                        @endif
                        <form action="../edit/{{$b1license->ID}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group" style="padding-bottom:60px">
                                <h4 style="font-size:22px; font-family: Times New Roman">
                                 ...
                                 @foreach($drivingtests as $dt)
                                   <option
                                   @if($b1license->driving_tests_id == $dt->ID)
                                   {{"selected"}}
                                   @endif
