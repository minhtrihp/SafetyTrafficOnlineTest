            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">A1 License Question Tests</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li><a href="#">A1 License Question Tests</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="col-md-6 col-4 align-self-center">
                       <div class="text-right upgrade-btn">
                            <a href="{{ asset('admin/a1_license/add') }}"
                                    ...
                                    <table class="table user-table " style="font-size:20px; ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr style="font-family: Roboto; ">
                                                ...
                                                <td>{{$qts->correct}}</td>
                                                <td><a href="../a1_license/edit/{{$qts->ID}}">Edit</a></td>
                                                <td><a href="../a1_license/del/{{$qts->ID}}">Delete</a></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
